 ...
 *
 * @since 3.0
 * @version $Id: AbstractHashedMap.java 1533984 2013-10-20 21:12:51Z tn $
 */
public class AbstractHashedMap<K, V> extends AbstractMap<K, V> implements Map<K, V>
{
	 ...
	 * @param value  the value to add
	 */
	protected void reuseEntry(final HashEntry<K, V> entry, final int hashIndex, final int hashCode, final K key,
		final V value)
	{
