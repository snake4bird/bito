 ...
 */
public abstract class AbstractLinkedMap<K, V> extends AbstractHashedMap<K, V> implements Map<K, V>
{
	 ...
	 */
	protected static class LinkMapIterator<K, V> extends LinkIterator<K, V> implements MapIterator<K, V>
	{
	 ...
	 * EntrySet iterator.
	 */
	protected static class EntrySetIterator<K, V> extends LinkIterator<K, V> implements Iterator<Map.Entry<K, V>>
	{
