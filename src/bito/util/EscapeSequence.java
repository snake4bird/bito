...
public class EscapeSequence
{
	...
	public static String decode(String s, boolean allowerror)
	{
		if (s == null || s.length() == 0)
		{
			return s;
	...
	private static int append0(char[] cs, int i, StringBuffer sb, boolean allowerror)
	{
		try
		{
	...
	private static int appendU(char[] cs, int i, StringBuffer sb, boolean allowerror)
	{
		try
		{
	...
	private static int appendO(char[] cs, int i, StringBuffer sb, boolean allowerror)
	{
		int x = i + 1;
		StringBuffer xsb = new StringBuffer();
	...
	private static int appendX(char[] cs, int i, StringBuffer sb, boolean allowerror)
	{
		try
		{
			StringBuffer xsb = new StringBuffer();
