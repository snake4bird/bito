...
public class JSONArray implements List
{
	...
	public String join(String separator)
	{
		...
		for(i = 0; i < myArrayList.size(); i += 1)
		{
			...
			{
				sb.append(JSONObject.quote((String)o, true));
			}
	 ...
	 *  representation of the array.
	 */
	public String toString(int indent, JSON.Format f)
	{
		int i;
		Object o;
		StringBuffer sb = new StringBuffer();
		...
		sb.append(f.array_head_separator);
		for(i = 0; i < myArrayList.size(); i++)
		{
			...
			{
				sb.append(JSONObject.quote((String)o, f.wchar_encode));
			}
			else if (o instanceof Number)
			{
				sb.append(JSONObject.numberToString((Number)o));
		...
		sb.append(f.array_tail_separator);
		return sb.toString();
	}

	public void add(int location, Object object)
	{
		myArrayList.add(location, object);
	}
	...
	{
		return myArrayList.addAll(location, collection);
	}
	...
	{
		return myArrayList.listIterator(location);
	}

	public Object remove(int location)
	{
		return myArrayList.remove(location);
	}
	...
	{
		return myArrayList.set(location, object);
	}
	...
	{
		return myArrayList.subList(start, end);
	}
