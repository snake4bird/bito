...
public abstract class ObjectUtils
{
	...
	public static Object[] toObjectArray(Object source)
	{
		...
		if (!source.getClass().isArray())
			throw new IllegalArgumentException((new StringBuilder("Source is not an array: ")).append(source)
				.toString());
	...
	public static String identityToString(Object obj)
	{
		if (obj == null)
			...
			return (new StringBuilder(String.valueOf(obj.getClass().getName()))).append("@")
				.append(getIdentityHexString(obj)).toString();
	}
